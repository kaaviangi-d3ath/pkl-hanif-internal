...
@if($order->status === 'pending' && (isset($snapToken) || $order->snap_token))
<div class="card-footer bg-white py-5 text-center">
    <p class="text-muted mb-4">Selesaikan pembayaran Anda.</p>
    <button id="pay-button" class="btn btn-primary btn-lg px-5 py-3 shadow-sm rounded-3 fw-bold">
        💳 Bayar Sekarang
    </button>
</div>
...
{{-- Bagian Script juga disesuaikan --}}
@push('scripts')
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (payButton) {
                payButton.addEventListener('click', function() {
                    // Gunakan snapToken dari controller, jika kosong gunakan dari model order
